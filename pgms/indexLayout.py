...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(630, 688)
        MainWindow.setMinimumSize(QtCore.QSize(630, 688))
        MainWindow.setMaximumSize(QtCore.QSize(630, 688))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.categorysortbox = QtWidgets.QGroupBox(self.centralwidget)
        self.categorysortbox.setGeometry(QtCore.QRect(10, 0, 611, 311))
        font = QtGui.QFont()
...
"}")
        ...
        self.maleFemaleTab.setGeometry(QtCore.QRect(10, 80, 591, 171))
        font = QtGui.QFont()
        font.setFamily("Cambria")
...
"}")
        ...
        self.maleValueTable.setGeometry(QtCore.QRect(0, 0, 581, 131))
        font = QtGui.QFont()
        font.setFamily("Book Antiqua")
        font.setPointSize(11)
...
"}")
        ...
        self.categoryExportBtn = QtWidgets.QPushButton(self.categorysortbox)
        self.categoryExportBtn.setGeometry(QtCore.QRect(80, 260, 151, 41))
        self.categoryExportBtn.setStyleSheet("")
        self.categoryExportBtn.setObjectName("categoryExportBtn")
        self.categoryExportAllBtn = QtWidgets.QPushButton(self.categorysortbox)
        self.categoryExportAllBtn.setGeometry(QtCore.QRect(330, 260, 151, 41))
        self.categoryExportAllBtn.setStyleSheet("")
        self.categoryExportAllBtn.setObjectName("categoryExportAllBtn")
        self.awardedSortGroupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.awardedSortGroupBox.setGeometry(QtCore.QRect(10, 310, 611, 321))
        font = QtGui.QFont()
        font.setFamily("Book Antiqua")
        font.setPointSize(12)
        font.setBold(True)
...
"}")
        ...
        self.awardedValueTable.setGeometry(QtCore.QRect(10, 140, 591, 111))
        font = QtGui.QFont()
        font.setFamily("Book Antiqua")
        font.setPointSize(11)
...
"}")
        ...
        self.awardedExportBtn = QtWidgets.QPushButton(self.awardedSortGroupBox)
        self.awardedExportBtn.setGeometry(QtCore.QRect(70, 270, 151, 41))
        self.awardedExportBtn.setStyleSheet("")
        self.awardedExportBtn.setObjectName("awardedExportBtn")
        self.awardedExportAllBtn = QtWidgets.QPushButton(self.awardedSortGroupBox)
        self.awardedExportAllBtn.setGeometry(QtCore.QRect(320, 270, 151, 41))
        self.awardedExportAllBtn.setStyleSheet("")
        self.awardedExportAllBtn.setObjectName("awardedExportAllBtn")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.categoryExportBtn.setText(_translate("MainWindow", "Export"))
        self.categoryExportAllBtn.setText(_translate("MainWindow", "Export All"))
        ...
        self.awardedExportBtn.setText(_translate("MainWindow", "Export"))
        self.awardedExportAllBtn.setText(_translate("MainWindow", "Export All"))
